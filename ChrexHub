if game.PlaceId == 12109643 then
    ...
    local Window = Library.CreateLib("Chrex Hub Fencing", "Sentinel")
...
MainSection:NewToggle("ServerAdmin(NoHatsRequire)", "NoHatsRequire", function(state)
    if state then
--GUI
...
MainSection:NewToggle("RB BATTLES BOW", "You need the RB Battles Bow to make this work", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/n7r4WaS8'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("Sonic script", "No need netless (Use every key)", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/GB1fAfzp'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("InfiniteYeild", "A Admin GUI", function(state)
    if state then
...
MainSection:NewToggle("Gale Fighter", "Gale Fighter Run a Netless on the hub!", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/w2ZVEpmZ'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("Netless", "A netless", function(state)
    if state then
...
MainSection:NewToggle("Chair Script", "A Chair (For better stuff run netless)", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/LmWeUkpt'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("Ultimate Trolling GUI V2", "Ultimate trolling GUI V2", function(state)
    if state then
...
MainSection:NewToggle("Ultimate Trolling GUI V3", "Ultimate Trolling GUI V3", function(state)
    if state then
...
MainSection:NewToggle("Fencing GUI", "Fencing GUI", function(state)
    if state then
...
MainSection:NewToggle("RB Neptunion", "You need blue RB battles sword", function(state)
    if state then
...
MainSection:NewToggle("Selexity Hub", "A ReAnimate Script", function(state)
    if state then
...
MainSection:NewToggle("R6 Among us (Must use netless)", "Among Us (Use netless)", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/nYqgReC3'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("FE Car", "FE CAR", function(state)
    if state then
...
MainSection:NewToggle("FE Pog Dance (Use Netless)", "Pog Dance", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/P8TnFaJS'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("Achromatic (FreeVersion)(Use Netless)", "Use netless for this", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/8yVP3ScS'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("FE Smile (Use netless)", "Use netless for this", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/BrXnu1Dq'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("FE NeckSnap", "NeckSnap", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/JXbE8ym7'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
MainSection:NewToggle("FE No face", "FE No face", function(state)
    if state then
loadstring(game:HttpGet('https://pastebin.com/raw/qbexdLb3'))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
message.Text = "GUI MADE BY XXXTENTACION#9897"
wait(11)
message:Destroy()
end)
...
MainSection:NewToggle("Car dealership autofarm", "Autofarm", function(state)
    if state then
...
TrollingSection:NewToggle("Gravity gun (U have to be in driver seat)", "Gravity Gun", function(state)
    if state then
...
elseif game.PlaceId == 3956818381 then
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
    local Window = Library.CreateLib("Chrex Hub Ninja Legend", "Sentinel")
...
elseif game.PlaceId == 7541759836 then
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
    local Window = Library.CreateLib("Chrex Hub LOUBU#1", "Sentinel")
    
        -- MAIN
    local Main = Window:NewTab("Main")
    local MainSection = Main:NewSection("Main")
    
    MainSection:NewToggle("AUTOFARM (WONT STOP)", "CLICK HERE!", function(state)
    if state then
loadstring(game:HttpGet("https://raw.githubusercontent.com/2022NOON/2022NOON-Scripts/main/LoubuAutoFarm"))()
        print("Toggle On")
    else
        print("Toggle Off")
    end
...
elseif game.PlaceId == 155615604 then
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
    local Window = Library.CreateLib("ChrexHub PrisonLife", "Sentinel")
    ...
    MainSection:NewToggle("Admin commands", "CLICK HERE!", function(state)
    if state then
loadstring(game:HttpGet(('https://raw.githubusercontent.com/XTheMasterX/Scripts/Main/PrisonLife'),true))()
    ...
    MainSection:NewToggle("Infinite yeild", "CLICK HERE!", function(state)
    if state then
